...
create policy "contributors write documents" on public.documents for all to authenticated using (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id))) with check (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id)));
...
create policy "contributors write issues" on public.issues for all to authenticated using (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id))) with check (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id)));
...
create policy "contributors write events" on public.events for all to authenticated using (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id))) with check (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id)));
...
create policy "contributors write contacts" on public.contacts for all to authenticated using (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id))) with check (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id)));
...
create policy "contributors write generated_outputs" on public.generated_outputs for all to authenticated using (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id))) with check (exists (select 1 from public.opportunities o where o.id = opportunity_id and public.can_write_firm(o.firm_id)));
...
create policy "contributors write artefact_segments" on public.artefact_segments for all to authenticated using (exists (select 1 from public.raw_artefacts r where r.id = raw_artefact_id and public.can_write_firm(r.firm_id))) with check (exists (select 1 from public.raw_artefacts r where r.id = raw_artefact_id and public.can_write_firm(r.firm_id)));
...
create policy "contributors write extraction_candidates" on public.extraction_candidates for all to authenticated using (exists (select 1 from public.extraction_runs r where r.id = extraction_run_id and public.can_write_firm(r.firm_id))) with check (exists (select 1 from public.extraction_runs r where r.id = extraction_run_id and public.can_write_firm(r.firm_id)));
